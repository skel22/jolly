...
<div class="container mt-4">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-custom-primary" style="background: linear-gradient(45deg, #FF69B4, #FF1493); color: #FFFFFF; padding: 8px 12px; border-radius: 5px; text-decoration: none;" href="{{ route('jolproduct.index') }}"> Back</a>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('jolproduct.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
